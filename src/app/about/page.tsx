...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Meet the team behind Milk Man Toner Company. Family-owned and operated in Loomis, CA. Serving Northern California businesses with copiers, printers, toner, and managed print since 1999.",
  path: "/about",
});
    ...
    <>
      ...
      <section className="bg-steel-pale border-b-2 border-brand-black px-5 py-10 md:py-14 md:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-[12px] md:text-sm text-brand-mid leading-[1.65] max-w-2xl">
      ...
      {/* Team hero photo */}
      <div className="relative h-[280px] md:h-[380px] border-b-2 border-brand-black overflow-hidden">
        <Image
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h2 className="font-heading text-[26px] text-brand-black mb-4">
                The spirit of the milkman, brought to your office.
              </h2>
              <p className="text-[12px] text-[#555] leading-[1.8] mb-4">
            ...
            <div className="relative h-[320px] border-[1.5px] border-brand-black overflow-hidden">
              <Image
      ...
      {/* Buy Local banner */}
      <section className="relative h-[300px] md:h-[380px] border-t-2 border-b-2 border-brand-black overflow-hidden">
        <Image
      ...
      {/* Meet Shamus */}
      <section className="bg-steel-bg border-b border-steel-pale px-5 py-10 md:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="relative h-[300px] border-[1.5px] border-brand-black overflow-hidden">
              <Image
            ...
            <div>
              ...
              <p className="text-[12px] text-[#555] leading-[1.8] mb-5">
      ...
      <section className="px-5 py-10 md:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative h-[260px] border-[1.5px] border-brand-black overflow-hidden">
              <Image
                src="/images/van-sf.jpg"
                alt="Milk Man Toner Company delivery van on the streets of San Francisco"
                fill
                className="object-cover"
              />
            </div>
      ...
      {/* Team at Disneyland */}
      <section className="bg-brand-black border-t-2 border-b-2 border-brand-black px-5 py-10 md:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              <div className="text-[9px] tracking-[0.16em] text-steel-light uppercase mb-1.5">Our team</div>
              <h2 className="font-heading text-[26px] text-white mb-4">
                We invest in our people so they can invest in you.
              </h2>
              <p className="text-[12px] text-[#999] leading-[1.8] mb-4">
              ...
              <p className="text-[12px] text-[#999] leading-[1.8]">
                ...
                culture we&apos;ve built over 25 years.
              </p>
            </div>
            <div className="relative h-[280px] border border-[#333] overflow-hidden">
              <Image
      ...
      {/* Stats */}
      <section className="bg-steel-pale border-b-2 border-brand-black px-5 py-8 md:px-8">
      ...
      <section className="px-5 py-10 md:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            {/* Placer Grown badge */}
            <div className="flex flex-col items-center gap-2 border border-steel-pale p-5 md:w-44">
              <Image
              ...
              />
              <p className="text-[10px] text-brand-mid text-center leading-[1.5]">
                Proudly based in<br />Placer County, CA
              </p>
            </div>
          </div>
        </div>
